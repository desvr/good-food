    ...
    <div class="app-sidebar">
        ...
        <div class="main-sidemenu">
            ...
            <ul class="side-menu pt-4">
                <li class="slide">
                    <a class="side-menu__item has-link" data-bs-toggle="slide" href="{{ route('admin.chat.index') }}">
                        <i class="side-menu__icon fe fe-activity"></i>
                            <span class="side-menu__label mt-0">Чат с клиентами</span>
                    </a>
                </li>
                ...
                <li class="slide">
                    <a class="side-menu__item" data-bs-toggle="slide" href="{{ route('admin.product.index') }}">
                        <i class="side-menu__icon fe fe-grid"></i>
                        <span class="side-menu__label mt-0">Товары</span>
                        @if (!empty($vsp_product_count))
                            <span class="product-label mb-0">{{ $vsp_product_count }}</span>
                        @endif
                    </a>
                </li>
            </ul>
