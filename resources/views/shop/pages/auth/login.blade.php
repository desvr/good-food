...
<head>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            $("#phone").val('+71111111111').mask("+7 (999) 999-9999");
    ...
    <div class="flex flex-wrap">
        <div class="flex w-full flex-col md:w-1/2">
            ...
            <div class="mx-auto max-w-md my-auto flex flex-col justify-center pt-8 md:pt-0 md:px-6 text-center">
                <p class="text-3xl font-bold">С возвращением!</p>
                <p class="mt-2 text-gray-500">Укажите номер телефона для отправки СМС.</p>
                ...
                <div class="py-12 text-center">
                    <p class="whitespace-nowrap text-gray-600">
                        Не зарегистрированы?
                        <a href="{{ route('auth.registerPage') }}" class="underline-offset-4 font-semibold text-gray-900 underline hover:text-primary-dark transition duration-200">Быстрая регистрация</a>
                    </p>
                </div>
            </div>
        </div>
